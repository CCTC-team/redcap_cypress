Feature: D.120.100 Field Embedding
  ...
  Scenario: D.120.100 Field Embedding
    ...
    And I create a new project named "D.120.100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_redcap_val.xml", and clicking the "Create Project" button
    ...
    Then I should see table header and rows containing the following values in the logging table:
        ...
        | test_user1 | Create record 2 (Event 1 (Arm 1: Arm 1)) | email_v2 = 'User1@example.com',ptname_v2_v2 = 'User1' |
