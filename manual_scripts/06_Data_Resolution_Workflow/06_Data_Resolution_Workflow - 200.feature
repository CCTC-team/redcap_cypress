...
And I click on the button labeled "Close" in the dialog box
And I click on the Data Resolution Workflow icon for the field labeled "Name"
Given I select the radio labeled "Open query" in the dialog box
...
And I select the "Open unresponded" option from the Filters dropdown field identified by 'choose_status_type'
Then I should see a table header and row containing the following values in a table:
      | Record    | Data Quality rule and/or Field  | User Assigned  | First Update           | Last Update |
      | 1         | ptname_v2_v2                    |                | test_user3 "New query" | [same as first update] |
And I select the "All status types" option from the Filters dropdown field identified by 'choose_status_type'
Given I select the "email_v2" option from the Filters dropdown field with identified by 'choose_field_rule'
Then I should see a table header and row containing the following values in a table:
      | Record   | Data Quality rule and/or Field  | User Assigned  | First Update                    | Last Update |
      | 1        | email_v2                        | test_user2     | test_user1 "Please check email" | test_use1 "Closed" |
