Feature: D.115.600 - The system shall support the ability to download the PDF of data of all instruments/events of all records
  ...
  Scenario: Download PDF of data of all instruments/events of all records
    ...
    Then I create a new project named "D.115.600" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_redcap_val_.xml", and clicking the "Create Project" button
    ...
    And I click on the image "PDF" to download "PDF of data collection instruments containing saved data (all records)"
