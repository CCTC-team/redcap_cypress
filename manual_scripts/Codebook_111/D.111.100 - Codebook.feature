Feature: Codebook: The system shall support the viewing of codebook.
    ...
    Scenario: Adding fields and verifying Codebook.
        ...
        And I should see a table header and rows containing the following values in the codebook table:  
            ...
            | 7  | [checkbox]                                   | Checkbox                                  | 1 checkbox__1 Checkbox1                                               |
            | 7  | [checkbox]                                   | Checkbox                                  | 2 checkbox__2 Checkbox2                                               |
            | 7  | [checkbox]                                   | Checkbox                                  | 3 checkbox__3 Checkbox3                                               |
            | 7  | [checkbox]                                   | Checkbox                                  | 4 checkbox__4 Checkbox4                                               |
            ...
            | 9  | [radio_button_manual]                        | Radio Button Manual                       | 100 DDChoice100                                                       | 
            | 9  | [radio_button_manual]                        | Radio Button Manual                       | 101 DDChoice101                                                       | 
