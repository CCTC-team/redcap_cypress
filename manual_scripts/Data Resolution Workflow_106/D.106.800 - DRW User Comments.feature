...
Scenario: D.106.800 The system shall have the ability to add comments to fields.
      ...
      And  I upload a "csv" format file located at "redcap_val_fixtures\D.106.100_Data_Import", by clicking the button near "Choose file" to browse for the file, and clicking the button labeled "Upload file" to upload the file
      ...
      And I upload a "csv" format file located at "redcap_val_fixtures\D.106.100_Users", by clicking the button near "Choose file" to browse for the file, and clicking the button labeled "Upload" to upload the file
