...
Scenario: Project_redcap_val_9.1 Create Piping into questions
    ...
    And I create a new project named "Project_redcap_val_9.1" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_redcap_val.xml", and clicking the "Create Project" button
