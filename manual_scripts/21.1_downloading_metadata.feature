Feature: Downloading Metadata. The system shall support the ability to download metadata only (XML)

  As a REDCap end user
  I want to see that 21.1_downloading_metadata.feature is functioning as expected
    ...
    Scenario: 1 Download metadata only(XML)
        ...
        Given I login to REDCap with the user "Test_Admin"
        And I create a new project named "Project_redcap_val_21.1" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_redcap_val_Test_2024-05-31", and clicking the "Create Project" button 
