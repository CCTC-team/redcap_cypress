Feature: D.110.100 Special Functions  - The system shall support the ability to use Special Functions in data entry forms. The following subset of Special Functions is selected and tested: 
  ...
  Scenario: D.110.100_Special_Functions - Create Special functions 
    ...
    #ACTION: D.110.100.1 Create datediff special function into question
    
    When I click on the link labeled "My Projects"  
    And I click on the link labeled "Project_redcap_val_10.1" 
    ...
    #VERIFY: datediff functions correctly in question
  ...
  #ACTION: D.110.100.2 Create round special function to round to one decimal point into question
    ...
    #VERIFY: round functions correctly in question
    Then I should see "17.2" in the data entry form field "BMI Calculated" 
    And I select the submit option labeled "Save & Exit Record" on the Data Collection Instrument
    And I should see "Record Home Page"


   #ACTION: D.110.100.3 Create IF special function to round to one decimal point into question
    ...
    #VERIFY: IF functions correctly in question
    Then I should see "1" in the data entry form field "BMI suitable for study 1 = Suitable 0 = Not suitable" 
    And I select the submit option labeled "Save & Exit Record" on the Data Collection Instrument
    And I should see "Record Home Page"


    #ACTION: D.110.100.4 Create Mean special function to round to one decimal point into question
    ...
    #VERIFY: Mean functions correctly in question
    Then I should see "9" in the data entry form field "Mean sum of values" 
    And I select the submit option labeled "Save & Exit Record" on the Data Collection Instrument
    And I should see "Record Home Page"

    #ACTION: D.110.100.5 Create Length special function to round to one decimal point into question
    ...
    And I should see a Data Collection Instrument named "Data Types" for the Event named "Event 1"
    And I locate the bubble for the "Data Types" instrument on event "1" for record ID "1" and click on the bubble
    And I enter "Hello World" into the data entry form field labeled "Length of text" 

    

    #VERIFY: Length functions correctly in question
