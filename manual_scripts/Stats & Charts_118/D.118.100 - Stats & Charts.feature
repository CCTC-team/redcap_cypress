Feature: Stats and Charts: The system shall support the viewing of stats and charts.
    ...
    Scenario: Stats and Charts.
        ...
        Then I select "View as Pie Chart" on the dropdown field labeled "Multiple Choice Dropdown Manual"
        ...
        #When I hover the plot I should see details below 
        ...
        Then I select "View as Pie Chart" on the dropdown field labeled "Complete?"
        And I should see "a Pie Chart showing Complete 4(26.7%), Incomplete 6(40%), Unverified 5(33.3%)"
