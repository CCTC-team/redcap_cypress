Feature: D.107.100  Action Tags
  ...
  Scenario: D.107.100.1 - @CALCTEXT
    ...
    Then I should see "your" in the data entry form field "This is a CALCTEXT that will output the words you if they are greater than 10 or your child if less than 10. You could use this in piping to other fields." 
    ...
    And I should see "your" in the data entry form field "This is a CALCTEXT that will output the words you if they are greater than 10 or your child if less than 10. You could use this in piping to other fields." 
