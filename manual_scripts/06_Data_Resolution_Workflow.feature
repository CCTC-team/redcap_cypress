...
Step 5:
And I click on the Data Resolution Workflow icon for the input field labeled "Name"
...
Step 7:
Given I click on the Data Resolution Workflow icon for the input field labeled "Name"
Then I should see a table header and row containing the following values in the Data Resolution Workflow table:
      | Date / Time      | User   | Comments and Details   | 
      | mm/dd/yyyy hh:mm | test_user | Data Changes Made: ptname_v2_v2 = 'John' |
      | mm/dd/yyyy hh:mm | test_user2 | Action:Verified data value |
Given  I select the radio option "De-verify data value" in the dialog box
...
And  I enter "Test de-verify data" into the field identified by "dc-comment" 
And  I click on the button labeled "De-verify data value"
...
And  I enter "Please check email" into the field identified by "dc-comment" 
...
Given I upload a "txt" format file located at "/import_files/Send-it.txt", by clicking the button near "Upload file (optional)" to browse for the file, and clicking the button labeled "Upload File" to upload the file
Then I should see "Document was successfully uploaded"
And I click on the button labeled "Close" in the dialog box
And  I enter "The value is correct" into the field identified by "dc-comment" 
...
Step 15:
Given I click on the Data Resolution Workflow icon for the input field labeled "Email"
