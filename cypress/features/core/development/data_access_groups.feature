Feature: Data Access Groups (DAGs)
    ...
    #-------------------------------------------------------------------------------------
    # 10.1 The system shall allow for the creation of DAGs and the deletion of DAGs if no users or records are assigned to it. 
    # 10.2 The system shall support adding and removing users from DAGs. 
    # 10.3 The system shall allow a user to be added to more than one DAG. 
    # 10.4 The system shall provide the ability to restrict a user who has been assigned to a DAG to: 
    #     10.4.1 data they entered 
    #     10.4.2 data entered by any member of the same DAG 
    # 10.5 The system shall provide the ability to assign records to a DAG from the Record Home page or from the form dropdown list when creating a new record.  
    # 10.6 The system shall provide the DAG unique group names in the data export raw CSV file and the label in the CSV labels data file.
    #-------------------------------------------------------------------------------------
