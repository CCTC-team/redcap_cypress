Feature: Data Quality
  ...
  Scenario:58 Name test Rule violated
    ...
    And I should see "Name Test" rule violation
  ...
  Scenario: 68 Create a DAG and assign User
    ...
    And the AJAX "POST" request at "index.php?route=DataAccessGroupsController:*" tagged by "dataAccess" is being monitored
  ...
  Scenario: 71 Execute all rules
    ...
    Then Discrepancies for Record "1-1Event 1 (Arm 1: Arm 1)", under Rule A should appear in the table identified by "table[id=table-results_table_pd-3]"
  ...
  Scenario: 72 Login as Admin and confirm Admin sees a higher number of discrepancies
    ...
    And I click "view" Total Discrepancies under Rule "A"
    Then Discrepancies for Record "1-1Event 1 (Arm 1: Arm 1)(DAG1)", under Rule A should appear in the table identified by "table[id=table-results_table_pd-3]"
