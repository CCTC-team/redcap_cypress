...
E.124.600 - The system shall support the ability to modify Highlight DQ Rules external module by non-admins with explicit module-level permission.
...
E.124.800 - The system shall support the ability to view data quality errors in line with the question when the option enabled in Highlight DQ Rules external module.
...
E.124.1200 - The system shall support the ability to view the usage of Highlight DQ Rules external module.