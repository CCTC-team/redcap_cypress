...
E.122.600 - The system shall support the ability to modify Versioning external module by non-admins with explicit module-level permission
E.122.700 - The system shall support the ability to setup and up-version project versions through Versioning external module
E.122.800 - The system shall support the ability to make the version field as READONLY through Versioning external module
E.122.900 - The system shall support the ability to use Versioning external module for Repeating Events/Instruments
